...
public class ConsultationService {
    ...
    // Vérifier s'il y a une consultation existante à moins de 15 minutes
    ...
    ordonnance.setConsultation(savedConsultation); // Lien entre ordonnance et consultation

    // Sauvegarder l'ordonnance
    ordonnanceService.createOrdonnance(ordonnance);

    // Retourner la consultation sauvegardée
